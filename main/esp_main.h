...
// Habilitar para realizar inferências a partir de imagens pré-carregadas (em vez de usar a câmera). 
// As imagens devem ser convertidas para o formato raw e adicionadas ao projeto como binários. 
#define CLI_ONLY_INFERENCE 1

// Habilitar para coletar estatísticas de CPU e fazer análise detalhada de tempo gasto em cada tipo de operação
